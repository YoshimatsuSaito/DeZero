...
def matmul(x, W):
    return MatMul()(x, W) 
    # The reason why this code make it possible to calculate forward method without coding directly writing forward method of MatMul class is
    # MatMul() call Function class and __call__ mathod do forward method (see core.py)
